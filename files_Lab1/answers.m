...
imwrite(b63_nearest, 'b63_nearest_image.png');  % Spara som PNG-bild
imwrite(b63_linear, 'b63_linear_image.png');  % Spara som PNG-bild
imwrite(b63_cubic, 'b63_cubic_image.png');  % Spara som PNG-bild
...
imwrite(b64_up, 'b64_image.png');  % Spara som PNG-bild
...
imwrite(b65, 'b65_image.png');  % Spara som PNG-bild
...
imwrite(b67, 'b67_image.png');  % Spara som PNG-bild
...
% spara bilen
imwrite(b68, 'b68_image.png');  % Spara som PNG-bild
